...
[![CI](https://github.com/autodesk-platform-services/aps-viewer-sdk/actions/workflows/ci.yml/badge.svg)](https://github.com/autodesk-platform-services/aps-viewer-sdk/actions/workflows/ci.yml)
...
```bash
git clone https://github.com/autodesk-platform-services/aps-viewer-sdk.git
cd aps-viewer-sdk
uv sync
uv sync --group test
```
